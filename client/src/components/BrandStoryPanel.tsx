...
export function BrandStoryPanel() {
  ...
  return (
    <aside className="rounded-2xl p-8 lg:p-10 shadow-lg h-full flex flex-col justify-center bg-[hsl(184,52%,25%)] text-[hsl(38,46%,91%)]">
      <div className="mb-5 w-11 h-11 rounded-xl bg-white/10 flex items-center justify-center">
